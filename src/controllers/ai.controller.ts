import { Controller, FileTypeValidator, MaxFileSizeValidator, ParseFilePipe, Post, Res, StreamableFile, UploadedFile, UseInterceptors } from '@nestjs/common';
...
export class AiController {
  ...
  ) file: Express.Multer.File, @Res({passthrough: true}) res: Response) {
